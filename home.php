...
<section id="layanan" class="px-8 py-20 mx-auto text-center max-w-7xl">
    <div class="max-w-xl m-auto mb-8 text-center">
        ...
        <p class="text-sm font-light text-slate-600 md:font-normal"><span class="font-semibold text-sky-500">OK Laudry</span> punya 3 layanan yang dapat anda pilih. Sesuaikan layanan dengan kebutuhan anda ya😁</p>
    </div>
        ...
        <div class="flex flex-col justify-between w-full p-3 border border-gray-200 rounded-lg shadow md:w-1/4 bg-slate-200 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div>
                <div class="flex items-center justify-between">
                    ...
                    <button data-modal-target="layanan-cuci-basah" data-modal-toggle="layanan-cuci-basah" class="text-white bg-sky-700 hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-sky-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-sky-800">Add
                        to cart</button>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col justify-between w-full p-3 border border-gray-200 rounded-lg shadow md:w-1/4 bg-slate-200 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div>
                <div class="flex items-center justify-between">
                    ...
                    <button data-modal-target="layanan-cuci-kering" data-modal-toggle="layanan-cuci-kering" class="text-white bg-sky-700 hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-sky-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-sky-800">Add
                        to cart</button>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col justify-between w-full p-3 border border-gray-200 rounded-lg shadow md:w-1/4 bg-slate-200 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div>
                <div class="flex items-center justify-between">
                    ...
                    <button data-modal-target="layanan-kombo" data-modal-toggle="layanan-kombo" class="text-white bg-sky-700 hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-sky-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-sky-800">Add
                        to cart</butt>
                </div>
            </div>
        </div>
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <div class="flex items-center justify-center h-full">
                        <div class="w-4/5 p-5 mx-auto border-2 rounded-md shadow-md bg-sky-200 border-slate-400 md:w-1/2">
                            ...
                            <p class="mt-3 text-xs font-medium text-justify md:text-base text-summary"><?= $data['review'] ?></p>
                        </div>
                    </div>
                </div>
            <?php } ?>
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <div class="flex items-center justify-center h-full">
                    <div class="w-4/5 p-5 mx-auto border-2 rounded-md shadow-md bg-sky-200 border-slate-400 md:w-1/2">
                        ...
                        <p class="mt-3 text-xs font-medium text-justify md:text-base">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Omnis debitis neque quaerat possimus non vero iste voluptatibus fugit</p>
                    </div>
                </div>
            </div>
            <!-- Item 4 -->
...
<section class="max-w-5xl px-8 py-20 mx-auto">
    ...
    <form action="function/review.php" method="POST">
        ...
        <div class="flex my-5">
            ...
            <input type="number" min="0" max="5" id="bintang" name="bintang" class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 " placeholder="Rating" required>
        </div>
    ...
    <div class="relative w-full max-w-md max-h-full p-4">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                ...
                <button type="button" class="inline-flex items-center justify-center w-8 h-8 text-sm text-gray-400 bg-transparent rounded-lg hover:bg-gray-200 hover:text-gray-900 ms-auto dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="layanan-cuci-basah">
            ...
            <form class="p-4 md:p-5" action="function/proses.php" method="POST">
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <p class="mb-2 text-sm font-light text-red-500">*max 20kg</p>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="tanggal" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">tanggal & waktu
                            pengambilan</label>
    ...
    <div class="relative w-full max-w-md max-h-full p-4">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                ...
                <button type="button" class="inline-flex items-center justify-center w-8 h-8 text-sm text-gray-400 bg-transparent rounded-lg hover:bg-gray-200 hover:text-gray-900 ms-auto dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="layanan-cuci-kering">
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                    </svg>
                    <span class="sr-only">Close modal</span>
    ...
    <div class="relative w-full max-w-md max-h-full p-4">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                ...
                <button type="button" class="inline-flex items-center justify-center w-8 h-8 text-sm text-gray-400 bg-transparent rounded-lg hover:bg-gray-200 hover:text-gray-900 ms-auto dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="layanan-kombo">
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                    </svg>
                    <span class="sr-only">Close modal</span>
